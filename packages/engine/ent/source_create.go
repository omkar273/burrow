...
func (_c *SourceCreate) SetAccountEmail(v string) *SourceCreate {
	_c.mutation.SetAccountEmail(v)
	return _c
}

// SetStatus sets the "status" field.
func (_c *SourceCreate) SetStatus(v string) *SourceCreate {
...
func (_c *SourceCreate) check() error {
	...
	if _, ok := _c.mutation.AccountEmail(); !ok {
		return &ValidationError{Name: "account_email", err: errors.New(`ent: missing required field "Source.account_email"`)}
	}
	...
	if _, ok := _c.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`ent: missing required field "Source.status"`)}
	}
