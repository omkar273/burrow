...
func (_c *BlobCreate) SetUpdatedAt(v time.Time) *BlobCreate {
	_c.mutation.SetUpdatedAt(v)
	return _c
}

// SetNillableUpdatedAt sets the "updated_at" field if the given value is not nil.
func (_c *BlobCreate) SetNillableUpdatedAt(v *time.Time) *BlobCreate {
	if v != nil {
		_c.SetUpdatedAt(*v)
	}
	return _c
...
func (_c *BlobCreate) SetContentHash(v string) *BlobCreate {
	_c.mutation.SetContentHash(v)
	return _c
}

// SetSizeBytes sets the "size_bytes" field.
func (_c *BlobCreate) SetSizeBytes(v int64) *BlobCreate {
...
func (_c *BlobCreate) check() error {
	...
	if _, ok := _c.mutation.UpdatedAt(); !ok {
		return &ValidationError{Name: "updated_at", err: errors.New(`ent: missing required field "Blob.updated_at"`)}
	}
	if _, ok := _c.mutation.ContentHash(); !ok {
		return &ValidationError{Name: "content_hash", err: errors.New(`ent: missing required field "Blob.content_hash"`)}
	}
	if v, ok := _c.mutation.ContentHash(); ok {
		if err := blob.ContentHashValidator(v); err != nil {
			return &ValidationError{Name: "content_hash", err: fmt.Errorf(`ent: validator failed for field "Blob.content_hash": %w`, err)}
		}
	}
	if _, ok := _c.mutation.SizeBytes(); !ok {
		return &ValidationError{Name: "size_bytes", err: errors.New(`ent: missing required field "Blob.size_bytes"`)}
	}
	if v, ok := _c.mutation.SizeBytes(); ok {
		if err := blob.SizeBytesValidator(v); err != nil {
			return &ValidationError{Name: "size_bytes", err: fmt.Errorf(`ent: validator failed for field "Blob.size_bytes": %w`, err)}
		}
	}
	return nil
}
...
func (_c *BlobCreate) createSpec() (*Blob, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.ContentHash(); ok {
		_spec.SetField(blob.FieldContentHash, field.TypeString, value)
