mise exec -- go run ./packages/migrate --dry-run 
3 pending migration(s), not applied:

-- migrations/20260907130953_init_blob.sql
-- Create "blobs" table
CREATE TABLE `blobs` (
  `id` text NOT NULL,
...
-- migrations/20260907131251_add_source_object_version.sql
...
-- migrations/20260907205723_add_foreign_keys.sql
